...
def mainFunc(images: list[str], source, dest, jpeg_quality) -> None:
    for i in images:
        ...
        if not fileInfo is None:
            ...
            cv2.imwrite(dest+filename, image, [cv2.IMWRITE_JPEG_QUALITY, jpeg_quality])
...
if __name__ == "__main__":
    ...
    func = partial(mainFunc, source=source, dest=dest, jpeg_quality=jpeg_quality)
